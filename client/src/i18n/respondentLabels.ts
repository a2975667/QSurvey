import { SurveyLocale } from './surveyLocale';
...
export const RESPONDENT_STATIC_LABELS_BY_LOCALE: Record<SurveyLocale, QvStaticLabels> = {
  'en-US': {
...
export const QV_STATIC_LABELS_BY_LOCALE = RESPONDENT_STATIC_LABELS_BY_LOCALE;
